...
const CompanyPage = async ({params}: Props) => {
    ...
    return (
        <div className="mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <span
                className="px-2 py-1 rounded-full text-xs font-semibold bg-opacity-15 bg-indigo-600 text-indigo-800 dark:text-indigo-200"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li><strong className="text-gray-600 dark:text-gray-400">Адрес:</strong> <span
                                className="break-words">{company.address}</span></li>
                            <li><strong
                                className="text-gray-600 dark:text-gray-400">Руководитель:</strong> {company.leader}
                            </li>
                        </ul>
                    </div>
                    <div
